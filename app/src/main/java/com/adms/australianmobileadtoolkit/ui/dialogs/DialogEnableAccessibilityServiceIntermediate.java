...
public class DialogEnableAccessibilityServiceIntermediate extends Dialog implements android.view.View.OnClickListener {

    private String TAG = "DialogEnableAccessibilityServiceIntermediate";

    private FragmentManager thisFragmentManager;

    public DialogEnableAccessibilityServiceIntermediate(@NonNull Context context, @NonNull FragmentManager fragmentManager) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_accessibility_launch_intermediate);
